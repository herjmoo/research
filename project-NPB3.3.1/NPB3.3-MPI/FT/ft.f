...
c            if (.not.(err .le. epsilon)) goto 100
            if (.not.(err .le. epsilon)) verified = .FALSE.
         end do
c         verified = .TRUE.
c 100     continue
         continue
